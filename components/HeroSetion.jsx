...
import { Download, Mail, Github, Linkedin, Code, Terminal, Zap } from 'lucide-react';
      ...
      <div className="relative z-10 flex items-center justify-center  py-12 px-8">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="flex justify-center gap-8 mb-12 text-center">
            <div className="group">
              <div className="text-2xl font-bold text-white group-hover:text-blue-400 transition-colors">5+</div>
              <div className="text-sm text-slate-400">Years Experience</div>
            </div>
            <div className="w-px h-12 bg-slate-700" />
            <div className="group">
              <div className="text-2xl font-bold text-white group-hover:text-purple-400 transition-colors">100+</div>
              <div className="text-sm text-slate-400">Projects Completed</div>
            </div>
            <div className="w-px h-12 bg-slate-700" />
            <div className="group">
              <div className="text-2xl font-bold text-white group-hover:text-green-400 transition-colors">50+</div>
          ...
          <div className="flex justify-center gap-4 mt-12">
            <a href="#" className="p-3 border border-slate-700 hover:border-blue-400 rounded-full text-slate-400 hover:text-blue-400 transition-all duration-300 hover:scale-110">
